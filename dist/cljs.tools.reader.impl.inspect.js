...
goog.dependencies_.written["cljs.tools.reader.impl.inspect.js"] = true;
...
var l = (cljs.core.truth_(truncate)?(0):(function (){var x__17933__auto__ = (10);
var y__17934__auto__ = n;
return ((x__17933__auto__ < y__17934__auto__) ? x__17933__auto__ : y__17934__auto__);
})());
...
cljs.tools.reader.impl.inspect.inspect_STAR_ = (function (){var method_table__18405__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__18406__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__18407__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__18408__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__18409__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),cljs.core.get_global_hierarchy());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.tools.reader.impl.inspect","inspect*"),cljs.tools.reader.impl.inspect.dispatch_inspect,new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__18409__auto__,method_table__18405__auto__,prefer_table__18406__auto__,method_cache__18407__auto__,cached_hierarchy__18408__auto__));
})();
}
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("\""),cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.substring((0),(function (){var x__17933__auto__ = n;
var y__17934__auto__ = x.length;
return ((x__17933__auto__ < y__17934__auto__) ? x__17933__auto__ : y__17934__auto__);
...
cljs.core._add_method(cljs.tools.reader.impl.inspect.inspect_STAR_,cljs.coreIndexedSeq,(function (truncate,x){
return "<indexed seq>";
}));
...
module.exports = cljs.tools.reader.impl.inspect;
